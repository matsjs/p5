...
function draw() {
  ...
  asterism(galaxy[Math.floor(Math.random()*3)][Math.floor(Math.random()*3)], round(frameNo/(FPS*5)), 255*abs(2*cos(Math.PI*(frameNo/(FPS*5)))) );
  drawWords("elsker deg til stjernene og tilbake\nMarien min", twinkleCounter)
  starshot.draw();
